...
export const en: Dictionary = {
  ...
  about: {
    label: "Who I am",
    title: "About me",
    description: "My journey, how I think about work, and what drives me day to day.",
  ...
  experience: {
    label: "Background",
    title: "Experience",
    description: "Where I've been, and what I took from each place.",
    current: "Current",
  ...
  panel: {
    ...
    contributionOther: "contributions",
